...
plt.plot(data[2][775:870])
plt.plot(data[2][775:782])
print(data[2][775])
predict_S, predict_I, predict_H, predict_R = calc(N, data[0][782] - data[0][775], data[2][775], 0, 0, 100, beta, pc, theta, gammaI, deltaq)
